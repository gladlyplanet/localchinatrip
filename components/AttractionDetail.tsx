...
const priorityDestinationMeta: typeof destinationMeta = {
  "Chengdu Panda Base": {
    ...
    advice: [
      { icon: "camera", title: simplePhrase("Arrive early", "清晨入园", "清晨入園"), body: simplePhrase("Pandas are usually more active in the cooler morning, so start with the key panda areas before crowds build.", "凉爽清晨更容易看到熊猫进食和活动，应先安排核心馆区，再根据人流调整路线。", "涼爽清晨更容易看到熊貓進食和活動，應先安排核心館區，再根據人流調整路線。") },
      { icon: "shoe", title: simplePhrase("Follow bamboo paths", "顺着竹林动线", "順著竹林動線"), body: simplePhrase("Use the walking route between panda houses, outdoor yards and bamboo groves instead of treating the visit as one photo stop.", "把熊猫馆舍、室外活动场和竹林步道串起来看，而不是只停在一个拍照点。", "把熊貓館舍、室外活動場和竹林步道串起來看，而不是只停在一個拍照點。") },
      { icon: "book", title: simplePhrase("Read conservation context", "理解保护背景", "理解保護背景"), body: simplePhrase("Connect what visitors see with breeding research, habitat protection, public education and animal welfare rules.", "把现场看到的熊猫行为和繁育研究、栖息地保护、公众教育及动物福利规则联系起来。", "把現場看到的熊貓行為和繁育研究、棲息地保護、公眾教育及動物福利規則聯繫起來。") },
      { icon: "hat", title: simplePhrase("Keep quiet space", "安静观察", "安靜觀察"), body: simplePhrase("Leave time for waiting and observation, and avoid noise or rushed viewing around animal areas.", "给等待和观察留时间，在动物活动区保持安静，不催促、不喧哗。", "給等待和觀察留時間，在動物活動區保持安靜，不催促、不喧嘩。") }
    ],
    guide: [
      { icon: "route", title: simplePhrase("Route by activity time", "按活动时段走", "按活動時段走"), body: simplePhrase("Arrange the route around morning activity, feeding windows, panda houses and crowd conditions.", "根据清晨活动、饲喂窗口、熊猫馆舍位置和现场人流安排顺序。", "根據清晨活動、餵食窗口、熊貓館舍位置和現場人流安排順序。") },
      { icon: "book", title: simplePhrase("Conservation explanation", "保护科普讲解", "保護科普講解"), body: simplePhrase("Explain behavior, diet, nursery care, research work and habitat protection in simple language.", "用容易理解的方式讲清熊猫行为、食性、幼崽照护、科研繁育和栖息地保护。", "用容易理解的方式講清熊貓行為、食性、幼崽照護、科研繁育和棲息地保護。") },
      { icon: "car", title: simplePhrase("Smooth transfer", "轻松接送安排", "輕鬆接送安排"), body: simplePhrase("Use private transfer for early arrival, family groups and flexible return after the visit.", "适合安排清晨接送、家庭同行和参观后灵活返程。", "適合安排清晨接送、家庭同行和參觀後靈活返程。") }
    ]
  },
  "Longjing Village": {
